...
document.onclick=function(){if(a==g){encenderMotor();}
else{apagarMotor();}}
...
function moverNave(){v+=a*dt;vel=v.toFixed(2);document.getElementById("velocidad").innerHTML=vel;y+=v*dt;y2-=v*dt;alt=y2.toFixed(2);document.getElementById("altura").innerHTML=alt;if(y<70){document.getElementById("nave").style.top=y+"%";}
else{stop();finalizarJuego();}}
...
function finalizarJuego(){if(v>5){document.getElementById("fotonave").src="img/explosion.png";document.getElementById("finJuego").style.display="block";document.getElementById("intentos").innerHTML=intentos;}